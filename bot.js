...
.addField❖ -clear ➾  البوت يمسح الرسال برقم حد اقصي 100 رساله 
...
.addField❖ -support ➾ للتواصل مع صاحب البوت

.addField❖ -id ➾ معلومات عنك

.addField❖ -avatar ➾ للعرض صورتك او صورة شخص فقط قم بعمل منشن له 
...
.addField❖ -invite ➾  لدعوة البوت لسرفرك

.addField❖ -kiss ➾  يعطي قبله لمن تختار في السيرفر عن طريق المنشن 

.addField❖ -slap ➾  يعطي كف لمن تختاره في السيرفرعن طريق المنشن

.addField❖ -hug ➾  يعطي وحضن او ضمه لمن تختاره في السيرفر عن طريق المنشن
...
.addField❖ -مريم ➾  لعبه مريم المخيفه

.addField❖ -غرد  ➾  للتغريد للشخص عن طريق المنشن
.addField╔[❖════════════❖]╗
                    Welcome
.addField╚[❖════════════❖]╝
